...
const filters: ReportFilters = {search: '', datePreset: 'all', customStart: '', customEnd: '', tags: [], runningOnly: false, durationPreset: 'all', customDurationMinutes: 0, groupBy: 'none'};
